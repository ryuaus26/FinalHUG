...
fig = px.choropleth(wp_df_melted, locations='ISO-3', color='Population', locationmode="ISO-3", scope="asia",
                    ...
                    range_color=(0, 120000000), animation_frame='Year', color_continuous_scale=px.colors.sequential.Viridis)
