...
future_years = [year for year in range(2030, 3005, 5)]
future_data = []
...
fig = px.choropleth(wp_df_melted, locations='ISO-3',
                    color='Population', locationmode="ISO-3", scope="south america", width=1200, height=600,
                    title='South America Population by Country (1970-3000)', hover_name="Country",
                    hover_data={'ISO-3': False,}, projection='equirectangular', range_color=(0, 700000000),
